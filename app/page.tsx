        ...
        <Card className=" flex flex-col md:flex-row sm:flex-row bg-gradient-to-t from-blue-950 via-slate-950 to-slate-950 relative items-center md:w-[70%] text-center text-xl">
          <CardHeader>
            ...
            <CardDescription className="items-start md:text-left sm:text-center">
              With a decade of military leadership, transitioning to a Junior
              Full Stack Developer. Combining problem-solving, adaptability, and
              a tech passion for dynamic web projects. Uniquely skilled in
              leadership, detail-oriented, and proven resilience in challenging
              environments.
            </CardDescription>
          </CardHeader>
